...
const cohorts = [
  { name: 'Frequent ED users (≥4 visits/year)', size: 87, risk: 'High' as const, trend: '+12%' },
  { name: 'Diabetes + hypertension patients', size: 142, risk: 'Medium' as const, trend: '+5%' },
  { name: 'Elderly (>75) with 2+ comorbidities', size: 63, risk: 'High' as const, trend: '+8%' },
];
